...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void MouseMove()
    {
        ...
        rotation.eulerAngles += new Vector3(0f, Input.GetAxis("MouseAxis1") * mouseSensitivity * Time.deltaTime * Time.timeScale, 0f);
    ...
    private void PlayerMove()
    {
        ...
        // Play footstep sound
        if (vector.magnitude > 0f || vector2.magnitude > 0f)
        {
            if (running)
            {
