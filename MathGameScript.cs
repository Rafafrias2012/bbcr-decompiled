...
public class MathGameScript : MonoBehaviour
{
	...
	public List< AudioClip> bal_howto=new List<AudioClip>();

	public List< AudioClip> bal_intro=new List<AudioClip>();
	...
	private void Update()
	{
		...
		if ((UnityEngine.Input.GetKeyDown("return") || UnityEngine.Input.GetKeyDown("enter")) & questionInProgress)
		{
    ...
    private void QueueAudio(List<AudioClip> sound)
    {
